...
下载cvs20测试程序包，请放到对应的板子上面，测试步骤：
  ...
  python3 -m dfss --url=open@sophgo.com:sophon-pipeline/a2_bringup/test_pack_cvs20_v1.6.tar #v1.6是版本号，最新版本为test_pack_cvs20_latest.tar
  tar xvf test_pack_cvs20_v1.6.tar
