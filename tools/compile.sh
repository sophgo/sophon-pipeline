...
function build_all() {
    ...
    build_app $1 $2 "-DUSE_QTGUI=ON -DWITH_DETECTOR=ON -DWITH_EXTRACTOR=ON -DHDMI_2K=ON " cvs20_all_gui_2k $3
    build_app $1 $2 "-DUSE_QTGUI=ON -DWITH_DETECTOR=ON -DWITH_EXTRACTOR=ON -DHDMI_2K=ON -DWITH_ENCODE=ON -DWITH_HDMI=OFF -DENC_H264=ON" cvs20_all_gui_2k_enc_h264 $3
    build_app $1 $2 "-DUSE_QTGUI=ON -DWITH_DETECTOR=ON -DWITH_EXTRACTOR=ON -DHDMI_2K=ON -DWITH_ENCODE=ON -DWITH_HDMI=OFF -DENC_JPEG=ON" cvs20_all_gui_2k_enc_jpg $3
    build_app $1 $2 "-DUSE_QTGUI=ON -DWITH_DETECTOR=ON -DWITH_EXTRACTOR=ON -DHDMI_2K=OFF -DHDMI_4K=ON" cvs20_all_gui_4k $3
    build_app $1 $2 "-DUSE_QTGUI=ON -DWITH_DETECTOR=ON -DWITH_EXTRACTOR=ON -DHDMI_2K=OFF -DHDMI_4K=ON -DWITH_ENCODE=ON -DWITH_HDMI=OFF -DENC_H264=ON" cvs20_all_gui_4k_enc_h264 $3
    build_app $1 $2 "-DUSE_QTGUI=ON -DWITH_DETECTOR=ON -DWITH_EXTRACTOR=ON -DHDMI_2K=OFF -DHDMI_4K=ON -DWITH_ENCODE=ON -DWITH_HDMI=OFF -DENC_JPEG=ON" cvs20_all_gui_4k_enc_jpg $3
    build_app $1 $2 "-DUSE_QTGUI=ON -DWITH_DETECTOR=ON -DWITH_EXTRACTOR=ON -DHDMI_2K=OFF -DHDMI_1080P=ON" cvs20_all_gui_1080p $3
    build_app $1 $2 "-DUSE_QTGUI=ON -DWITH_DETECTOR=ON -DWITH_EXTRACTOR=ON -DHDMI_2K=OFF -DHDMI_1080P=ON -DWITH_ENCODE=ON -DWITH_HDMI=OFF -DENC_H264=ON" cvs20_all_gui_1080p_enc_h264 $3
    build_app $1 $2 "-DUSE_QTGUI=ON -DWITH_DETECTOR=ON -DWITH_EXTRACTOR=ON -DHDMI_2K=OFF -DHDMI_1080P=ON -DWITH_ENCODE=ON -DWITH_HDMI=OFF -DENC_JPEG=ON" cvs20_all_gui_1080p_enc_jpg $3
