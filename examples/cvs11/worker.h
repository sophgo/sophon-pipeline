...
class OneCardInferApp {
    ...
    std::shared_ptr<bm::DetectorDelegate<bm::cvs11FrameBaseInfo, bm::cvs11FrameInfo>> m_detectorDelegate;
    ...
    bm::BMInferencePipe<bm::cvs11FrameBaseInfo, bm::cvs11FrameInfo> m_inferPipe;
...
public:
    ...
    void setDetectorDelegate(std::shared_ptr<bm::DetectorDelegate<bm::cvs11FrameBaseInfo, bm::cvs11FrameInfo>> delegate){
