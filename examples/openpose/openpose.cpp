...
OpenPose::OpenPose(bm::BMNNContextPtr bmctx, std::string strModelType, float nms_threshold):m_bmctx(bmctx), m_nms_threshold(nms_threshold)
{
...
void OpenPose::decode_from_output_tensor(bm::FrameInfo &frame_info) {
    ...
    OpenPosePostProcess::getKeyPoints(
        tensorPtr, netInputSize, originSize, vct_keypoints, m_model_type, m_nms_threshold
    );
